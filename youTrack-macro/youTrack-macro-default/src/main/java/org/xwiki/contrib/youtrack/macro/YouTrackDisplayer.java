...
/**
 * A YouTrack Displayer is used to display the YouTrack issues visually. Example of Displayers:
 * Table displayer which displays
 ...
 */
@Role
public interface YouTrackDisplayer
{
    /**
     * Displays the passed YouTrack issues.
     *
     ...
     *            configuration data (for example displayers allows the user to specify the list of
     *                   YouTrack issue fields to
     *            display
